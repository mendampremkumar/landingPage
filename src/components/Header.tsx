...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center mt-5">
      <div className="bg-background/95 backdrop-blur-sm border border-border rounded-full px-6 lg:px-8">
